...
//+++++++++++++++++++++++++++++++++++++++++++++++++++
    ,
//+++++++++++++++++++++++++++++++++++++++++++++++++++
    searchLegForm: function (stopsOptions) {
//+++++++++++++++++++++++++++++++++++++++++++++++++++
        // do NOT forget opening ` !
        return `
...
<tr><td colspan="6">Search for records that: 
  ...
  <input class="bigbutton" type="button" name="skip" id="skip" onclick="searchLegs('and=(notes.eq.*NOTHING*)')" value="Skip/Cancel"></input>
        ...
        <tr>
            ...
            <td>
                <select id="col_stopfrom" name="stopfrom" onChange="changePGRESTWhere(['id','name','stopfrom','stopto','notes','startdatetime','enddatetime','type'])">
                   ${stopsOptions}
                </select>
            </td>
            <td class="colname">To:
            ...
            <td>
                <select id="col_stopto" name="stopto" onChange="changePGRESTWhere(['id','name','stopfrom','stopto','notes','startdatetime','enddatetime','type'])">
                   ${stopsOptions}
                </select>
            </td>
        </tr>
