...
// ***********
        ...
        if (startAt) {
            ...
            APP.map = MAP.init("ShowJourneysMap", [6.89, 52.22], 11, selectClickedJourney);  //Enschede
        }
...
async function doJourneySearchAndShow(theWhereStr, displayTable = true, displayMap = true,
    ...
    UI.SetMessage(APP.journeys.getNumJourneys() + " Journeys found in DB. Click in map or table to alter selection...", workflowMsg);
